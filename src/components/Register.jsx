  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pink-100">
      <div className="w-full max-w-md p-8 bg-white rounded-xl shadow-lg border border-pink-300">
        <h2 className="text-3xl font-serif font-bold text-pink-900 mb-6 text-center">Create Account</h2>
        <form className="space-y-5">
          <div>
            <label className="block text-pink-800 font-medium mb-1">Name</label>
          ...
          <button type="submit" className="w-full py-2 bg-pink-700 text-white font-semibold rounded-lg hover:bg-pink-800 transition">Register</button>
        </form>
        <p className="mt-4 text-center text-pink-700">Already have an account? <a href="/login" className="underline font-semibold">Login</a></p>
      </div>
    </div>
  );
}
