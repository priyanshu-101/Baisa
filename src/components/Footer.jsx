  ...
  return (
    <footer className="bg-pink-100  text-pink-900 mt-10">
      <div className="w-full mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <h2 className="text-2xl font-serif font-bold mb-2 text-pink-700">Baisa</h2>
          <p className="mb-4 text-pink-800">Luxury meets tradition. Hand-painted, curated, and crafted for you.</p>
